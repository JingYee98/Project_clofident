...
import 'package:clofident_lastest/registerScreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String urlLogin = "https://albeeneko.com/clofident/php/login_user.php";
          ...
          builder: (context) => new AlertDialog(
            ...
            actions: <Widget>[
              MaterialButton(
                  ...
                  child:
                      Text("Exit", style: TextStyle(color: Colors.cyan[100]))),
              MaterialButton(
                  onPressed: () {
