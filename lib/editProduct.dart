...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    sizeEditingController.text = widget.product.size;
    selectedType = widget.product.type;
    print(sizeEditingController.text);
  }
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: CachedNetworkImage(
                          fit: BoxFit.fill,
                          imageUrl:
                              server + "/productimage/${widget.product.id}.jpg",
                          ...
                          decoration: BoxDecoration(
                            image: new DecorationImage(
                              colorFilter: new ColorFilter.mode(
                                  ...
                                  BlendMode.dstATop),
                              image: _image == null
                                  ? AssetImage('assets/images/camera (1).png')
                                  : FileImage(_image),
                              fit: BoxFit.cover,
                            ),
                          ),
