...
import 'dart:convert';
import 'dart:io';
import 'package:clofident_lastest/mainScreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:clofident_lastest/editProduct.dart';
import 'package:clofident_lastest/newProduct.dart';
import 'package:clofident_lastest/product.dart';
...
class _AdminScreenState extends State<AdminScreen> {
  ...
  var _tapPosition;
  String server = "https://albeeneko.com/clofident";
  String scanPrId;
          ...
          floatingActionButton: SpeedDial(
            ...
            children: [
              ...
              SpeedDialChild(
                  ...
                  label: "Scan Product",
                  labelStyle: TextStyle(color: Colors.white),
                  labelBackgroundColor: Colors.indigo[300], //_changeLocality()
  ...
  gotoCart() {
    if (widget.user.email == "unregistered@clofident.com") {
